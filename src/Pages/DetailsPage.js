...
const DetailsPage = () => {
    ...
    return (
        <div className="w-full h-full bg-gray-300 min-h-screen overflow-auto flex justify-center pt-5">
            <div className="w-[90%] h-[92%] rounded shadow-md flex flex-col justify-between p-2 items-center">
                <div className="w-full h-12 rounded shadow-md bg-indigo-500 p-1 px-2 flex justify-between items-center text-xl text-white font-semibold">
                    <div>Hey Champ,</div>
